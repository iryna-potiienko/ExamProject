...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("ExaminationProject.PhotoAlbumAdapter, ExaminationProject", PhotoAlbumAdapter.class, __md_methods);
	}
	...
	public PhotoAlbumAdapter ()
	{
		...
		if (getClass () == PhotoAlbumAdapter.class)
			mono.android.TypeManager.Activate ("ExaminationProject.PhotoAlbumAdapter, ExaminationProject", "", this, new java.lang.Object[] {  });
	}
